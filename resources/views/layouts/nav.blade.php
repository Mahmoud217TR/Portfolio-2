<nav class="navbar container d-lg-flex justify-content-center mt-3 d-block">
    ...
    <ul class="navbar-nav flex-lg-row ms-auto mb-2 mb-lg-0 mt-3 mt-lg-0">
        ...
        <li class="nav-item @if(Route::currentRouteName() == 'projects') nav-item-active @endif text-center px-2"><a href="#">Projects</a></li>
        <li class="nav-item @if(Route::currentRouteName() == 'contact') nav-item-active @endif text-center px-2"><a href="#">Contact Me</a></li>
    </ul>
</nav>